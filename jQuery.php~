...
class jQuery {
	...
	*/
    ...
    /**
    * Simple GET request to target page
    *
    * @param string $url Target page to request
    * @return jQuery
    */
    ...
    /**
     * Simple POST request to target page
     *
     * @param string $url Target page to request
     * @param string $params Query string for post vars
     * @return jQuery
     */
